...
By using it in conjunction with the $\wand$ operator, it can be used to apply
...
the heap look like P, then Q will hold''. This combined operator is written as
$\hysep$ and pronounced \emph{blargh}.
...
\begin{display}{Inference Rules}
  ...
  \staterule{(Computed Access)}
    {
      ...
      \tr {R} {\js{e2}} {Q \sep X \dotin curlyX^U \sep \rv \doteq V_2}
  ...
  \staterule{(Assign Global Val)}
    {
      \tr P {\js{e1}} {R \sep \rv \doteq \fld{\nil}{X}} \\
      \tr R {\js{e2}} {Q \sep (\gv,X) \pointsto \none \sep \rv \doteq V_1} \\
      Q = S \sep \getValue(Ls, V_1, V_2) \sep \ReadWrite(\gv) \sep V_2
      \notdotin \loc
    }
    {\tr P {\js{e1 = e2}} {Q \sep (\gv, X) \pointsto V_2 \sep \rv \doteq V_2}}
  \vg

  \staterule{(Assign Local Val)}
    {
    ...
    {\tr P {\js{e1 = e2}} {Q = (L,X) \pointsto V_2 \sep \rv \doteq V_2}}
  \vg

  \staterule{(Assign Global Loc)}
    {
      \tr P {\js{e1}} {R \sep \rv \doteq \fld{\nil}{X}} \\
      \tr R {\js{e2}} {Q \sep (\gv,X) \mapsto \none \sep \rv \doteq V_2} \\
  ...
  \staterule{(Obj)}
    {
      \exists L \st \left(\begin{array}{l}
        \forall i \in 1..n \st \left(\begin{array}{l}
          ...
          \beta(X_i, L, \js{xi}, s_i)
        \end{array}\right) \\
        Q = P_n \sep \newobj(L, @proto, \js{x1} \ldots \js{xn}) \sep
        (L_1, \js{xi}) \pointsto X_i \sep \dots \sep (L_n, \js{xn}) \pointsto
        X_n \sep {} \\
  ...
  \staterule{(Fun Call)}
    {
      ...
      R_1 = \left(\begin{array}{l}
          ...
          (F_2, @body) \pointsto \lambda \js{x.e3} \sep (F_2, @scope) \pointsto
          Ls_2
      \end{array}\right) \\
      \tr {R_1} {\js{e2}} {R_2 \sep \ls \doteq Ls_3 \sep \rv = V_1} \\
      ...
      R_3 = \left(\begin{array}{l}
          ...
          \defs(X,L,\js{e3}) \sep {} \\
          \newobj(L,@proto,@this,\js{x},\vardecls( %FIXME 
