...
\newcommand{\gds}[1]{\ifmmode \textbf{**** gds: }\textrm{#1}\textbf{****}\else
  \\\textbf{************************************}\\
  \tabfill{\textbf{gds: }#1}\\\textbf{************************************}\\
  \fi}
\newcommand{\FIXME}[1]{~\vg\colorbox{red}{\textbf{FIXME:}}\tabfill{\textrm{ #1}}\vg}
\newcommand{\TODO}[1]{~\vg\colorbox{yellow}{\textbf{TODO:}}\tabfill{\textrm{ #1}}\vg}
