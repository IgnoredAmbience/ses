...
\[ MembraneInstance(M) = \obj_M(\js{ref}: \_, @this: \_, @proto: \nil,
  \js{MembraneRef}: F_{MR}, \js{kill}: F_{K})\]
      ...
      \tjs{var Membrane = function(ref) \{} \\
        \indblock{
          \logic{
            ...
            MRset_M([], T) \sep ref \bp S \cup T \sep
            \ls \doteq M:Ls
          } \\
          \tjs{var killed = false;} \\
          ...
          \logic{
            ...
            \newfun_{F_{MR}}(M:Ls,\js{ref},\lambda_{MR},\_)
              \sep \ls \doteq M:Ls
          } \\
          \tjs{var access = MembraneRef(ref);} \\
          \logic{
            \fullobj_{MR_0}(\js{ref}: ref, @this: \_, @proto: \nil, \js{access}:
              F_{A_0}) \sep {} \\
            \newfun_{F_{A_0}}(MR_0:\ls, \js{field}, \lambda_A, \_) \sep {} \\
            ((ref \dotin\uvals \sep \rv \doteq ref) \lor (ref \notdotin\uvals \sep \rv
            \doteq F_{A_n}))
          } \\
...
\begin{figure}
  \[
    \begin{array}{l}
      \logic{
        % alive(M) provides footprint for MembraneRef lookup... need to clarify
        alive(M) \sep MRset_M(Ls,T) \sep ref \bp S \cup T \sep ref \dotin \loc
      } \\
      \tjs{MembraneRef(ref);} \\
      \logic{
        alive(M) \sep MRset_M(MR:Ls,T') \sep MRef_{MR}(M,ref,F_A,S,T') \sep ref
        \dotin \loc \sep \rv \doteq F_A
      } \\
      \\
      \tjs{var MembraneRef = function(ref) \{} \\
        \indblock{
          \logic{
            alive(M) \sep  \fullobj_{MR}(\js{ref}: ref, @this: \_, @proto: \nil, \js{access}:
              \und) \sep {} \\
            ref \dotin \loc \sep
            MRset_M(MR:Ls,T') \sep ref \bp S \cup T' \sep \ls \doteq MR:M:Ls
          } \\
          \tjs{var access = function(field) \{...\}} \\
          \logic{
            alive(M) \sep \fullobj_{MR}(\js{ref}: ref, @this: \_, @proto: \nil, \js{access}:
              F_A) \sep {} \\
            \newfun_{F_A}(MR:M:Ls, \js{field}, \lambda_A, \_) \sep ref \dotin
            \loc \sep {} \\
            MRset_M(MR:Ls,T') \sep ref \bp S \cup T' \sep \ls \doteq MR:M:Ls
          } \\
          ...
          \step{subst} \\
          \logic{
            alive(M) \sep MRset_M(MR:Ls,T') \sep MRef_{MR}(M,ref,F_A,S,T') \sep
              {} \\
            ref \dotin \loc \sep rv \doteq F_A \sep \ls \doteq MR:M:Ls
          }
        }
      \tjs{\}} \\
      \\
