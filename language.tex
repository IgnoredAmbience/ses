...
% imports aren't present in the restricted-global this expression.
% TODO: Consider change to copy fields across to AR
...
\begin{display}{Auxillary Functions}
  ...
  % TODO: Some way of looping through (only user-def) fields.
...
\vg
  ...
  % FIXME: This is probably broken, we still need gammas...
  % Provable wrt. Hoare triples?
  \gds{Fix $\gamma$\\Hm - this is a small-step technique. To see why it won't work in a big step setting, try drawing\\
