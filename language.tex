...
\vg
  ...
  {H,L,\js{e1} \evalsto H_1,r_1\qquad
   ...
   H_1(l_1,@scope)= L'\\
   H_1,L,\js{e2} \gevalsto H_2,{v}\\
   H_3 = H_2\disju\act(l,\js x,v,\js{e3},l_2) \\
   H_3,l \cons L',\js{e3} \gevalsto H',{v'}}
  {H,L,\js{e1(e2)} \evalsto H',{v'}}
\vg

  \staterule{(Object construction)}
  {H,L,\js{e1} \gevalsto H_1,{l_1} \qquad
   l_1\neq \nil\qquad
   H_1(l_1,@body)=\lambda \js{x.e3}\\
   H_1(l_1,@scope)= L'\qquad
   H_1(l_1,\js{prototype})= v\\
   H_1,L,\js{e2} \gevalsto H_2,{v_1}  \qquad
   l_2 = \objOrGlob(v) \\
   H_3 = H_2\disju \obj(l_3,l_2) \disju\act(l,\js x,v_1,\js{e3},l_3)\\
...
\vg
  ...
  {H,L,e_1 \gevalsto H_1,v \qquad
   \parse(v) = e \\
   H_1,L,e_2 \gevalsto H_2, l \\
   H_3 = H_2 \disju l' \pointsto \{@this:l, @proto:\nil\} \disju \defs(x, l', e) \\
   H_3, l' \cons [l], e \gevalsto H',v }
  ...
  \staterule{(Object)}
    {
      ...
      \exists L \st \left(\begin{array}{l}
        ...
        \bigsep_{1 \leq i \leq n} (
          (L, \js{xi}) \pointsto X_i \sep \bpGen(X_i, L,\js{xi}, s_i)
        ) \sep {} \\
  ...
  \staterule{(Function Call)}
    {
      ...
      R_1 = \left(\begin{array}{l}
          ...
          Ls_2
      \end{array}\right) \\
      \tr {R_1} {\js{e2}} {R_2 \sep T \bp s \sep \bpGen(V_2,\_,\_,s') \sep
...
%  \vg
  ...
  \staterule{(Restricted evaluation)}
    {
      \tr{P}{\js{e1}}{R_1 \sep \rv \doteq V_1} \\
      R_1 = S_1 \sep \getValue(\_, V_1, V_2) \sep V_2 \dotin \text{String} \\ %% FIXME: STRING
      \parse(V_2) = \js{e3} \\
      \tr{R_1}{\js{e2}}{R_2 \sep \rv \doteq V_3 \sep \ls \doteq Ls \sep \gv \doteq g} \\
      R_2 = \left(\begin{array}{l}
        S_2 \sep \getValue(\_, V_3, V_4) \sep V_4 \dotin \loc \sep {} \\
        \exists L \st R_3 \sep
        \newobj_L(@proto,@this,\vardecls(...,\js{e3})) \sep {} \\
        \obj_L(@this: V_2, @proto: \nil) \sep \defs(...,\js{e3}) \sep {} \\
      \end{array}\right) \\
      R_3 = \ls \sep L:[V_2] \sep \gv \doteq V_2 \\
      \tr{R_2}{\js{e3}}{\exists L \st Q \sep R_3}
    }
    {\tr{P}{\js{reval(e1,e2)}}{\exists L \st Q \sep \ls \doteq Ls \sep \gv \doteq g}}
  \vg
