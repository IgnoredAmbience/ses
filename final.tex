...
Assume we want to allow the untrusted program read access to \js{cookies} until
they are modified by the main code in \js{updateCookies}.
...
An example body for \js{maliciousCode} could be:
